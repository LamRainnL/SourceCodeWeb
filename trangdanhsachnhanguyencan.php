...
<body>
    ...
    <div class="breadcrumb" style="margin-top: 10px; margin-bottom: 20px;margin-left: 10px;">
        <a href="/trangchu.php" style="text-decoration: none;">Trang chủ</a> &gt; Danh sách nhà nguyên căn
    </div>
    <!-- ---------danh sách phòng trọ----------->
    <div class="main">
        <div class="thanhphan">
            ...
            WHERE danhmuc.TenDanhMuc = 'Nhà nguyên căn' and phongtro.status='approved'";
            ...
            if (!$hasResults) {
                echo "<p>Không có nhà nào khả dụng.</p>";
            }
